    ...
    def test_parse_comment(self):
        ...
        response = '''
            {"response":{"comments":[5045,{
                ...
                "from_id":51550980,
                "date":1260721960,
                "text":"Возможно ли будет в будущем в контейнере вызвать showInviteBox с массивом уже отмеченных для приглашения друзей?"},
                {"id":11382,
                "from_id":1775328,
                "date":1260722859,
                "text":
                "Не совсем понял где писать, но решил написать здесь ... буквально неделю назад моё приложение заблокировали, а в причине написали нарушение правил пункт 5 в подписи. исправил, это не сложно, все возобновили.. НО.. ведь подобные нарушения замечены почти у всех приложений......<br>даже у таких популярных как это<br>http:\/\/vkontakte.ru\/app630896<br><br>вопрос. неужели правила не для всех едины?"},
                {"id":11394,"from_id":3908342,"date":1260729642,"text":"Егор Bicoz Филиппов, иногда администрация делает исключения на ссылки, которые ведут на официальные форумы.<br><br>Насколько помню, то сообщение от администрации было примерно такого плана: &quot;мы можем сделать исключения только в тех случаях, когда возможностей групп вконтакте недостаточно для поддержки приложения&quot;. Что-то типа того.<br><br>З.Ы. Егор и другие пользователи, которые будут выкладывать ссылки на приложения, убирайте пожалуйста реф-часть."}]}}'''
