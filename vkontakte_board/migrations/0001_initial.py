...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Topic'
        db.create_table('vkontakte_board_topic', (
            ...
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='topics', to=orm['vkontakte_groups.Group'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='topics_created', to=orm['vkontakte_users.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='topics_updated', to=orm['vkontakte_users.User'])),
            ...
            ('comments_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('first_comment', self.gf('django.db.models.fields.TextField')()),
            ('last_comment', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('vkontakte_board', ['Topic'])

        # Adding model 'Comment'
        db.create_table('vkontakte_board_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fetched', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('remote_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length='20')),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['vkontakte_board.Topic'])),
            ('from_id', self.gf('django.db.models.fields.related.ForeignKey')(related_name='topics_comments', to=orm['vkontakte_users.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('vkontakte_board', ['Comment'])

    def backwards(self, orm):
        # Deleting model 'Topic'
        db.delete_table('vkontakte_board_topic')

        # Deleting model 'Comment'
        db.delete_table('vkontakte_board_comment')
    ...
    models = {
        ...
        'vkontakte_board.comment': {
            ...
            'from_id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'topics_comments'", 'to': "orm['vkontakte_users.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'vkontakte_board.topic': {
            ...
            'comments_count': ('django.db.models.fields.PositiveIntegerField', [], {}),
